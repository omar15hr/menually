    ...
    <div className="w-full bg-white flex flex-col min-h-screen">
      ...
      <div className="w-full mt-5 px-10 max-w-7xl mx-auto p-6">
        <h1 className="text-3xl font-extrabold text-left text-gray-900 mb-2 capitalize">
          {menu ? "Mi menú digital" : `${profile?.full_name}`}
        </h1>
              ...
              <div className="relative h-90 border-2 bg-linear-to-b border-[#CDF545] rounded-xl p-8 flex flex-col items-center text-center gap-4">
                ...
                <form className="w-full">
                  <Button
                    ...
                    name="intent"
                    value="import"
                    className="w-full bg-[#CDF545] hover:bg-[#bce43e] text-[#114821] font-semibold py-2.5 rounded-lg cursor-pointer"
                  >
                    Empezar
                  </Button>
                </form>
              ...
              <div className="border border-[#E2E8F0] rounded-xl p-8 flex flex-col items-center text-center gap-4">
                ...
                <form className="w-full">
                  <Button
                    ...
                    value="manual"
                    variant="outline"
                    className="w-full border-[#E4E4E6] text-[#0F172A] hover:bg-gray-50 font-semibold py-2.5 rounded-lg cursor-pointer"
                  >
                    Crear desde cero
                  </Button>
                </form>
