...
export const createPromotionSchema = z.object({
  ...
  keyword: z.string().min(1, "La palabra clave es requerida").max(30, "Máximo 30 caracteres"),
  product_ids: z.array(z.string().uuid("ID de producto inválido")).min(1, "Selecciona al menos un producto"),
